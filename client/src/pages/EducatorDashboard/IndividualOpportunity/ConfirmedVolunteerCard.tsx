...
const ConfirmedVolunteerCard = (props: any) => {
    ...
    return (
        <Card className={classes.card} elevation={0}>
            ...
            }}>{volunteer.firstName} {volunteer.lastName}</Typography>
            <Typography variant="body1" className={classes.body} >{volunteer.jobTitle} at {volunteer.employer.name} {`\u2013`} ({volunteer.preferredPronouns})</Typography>
        </Card>
    )
