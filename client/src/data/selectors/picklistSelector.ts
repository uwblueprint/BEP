...
export const getEmploymentStatus = createPicklistSelector(PicklistType.employmentStatus);

export const getIntroductionMethod = createPicklistSelector(PicklistType.introductionMethod);
